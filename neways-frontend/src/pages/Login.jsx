  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-between bg-[#ececec] py-8 px-4 font-sans text-gray-800">
      ...
      <div className="w-full max-w-sm flex flex-col items-center my-auto space-y-6">
        ...
        <div className="flex flex-col items-center space-y-2">
          ...
          <h2 className="text-2xl font-bold text-gray-900">
            {isRegistering ? 'Crear Cuenta' : 'Bienvenido/da'}
          </h2>
        </div>
        ...
        <form onSubmit={handleSubmit} className="w-full space-y-4">
          ...
          {/* Texto alternar modo registro/login */}
          ...
          {/* Botón Principal (Login / Registrarse) */}
      ...
      <div className="mt-8 flex flex-col items-center">
        <span className="text-purple-500 font-extrabold text-2xl tracking-tight leading-none">
          neways<span className="text-xs align-top">®</span>
        </span>
      </div>
